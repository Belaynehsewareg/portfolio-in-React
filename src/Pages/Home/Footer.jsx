    ...
    <footer className="footer--container">
      <div className="footer--link--container">
        <div className="navbar--images"> 
          <img src="./images/S.png" alt="Footer Log" width="80px" />
        </div>
        ...
        <div className="footer--social--icon">
          <ul>
            ...
            <li>
                <a
                    href="https://www.instagram.com/belayneh_21"
                    className="navbar--content"
                    target="_blank"
                    rel="noreferrer"
                >
            ...
            <li>
              <a
                href="https://www.linkedin.com/in/belayneh-sewareg-a039a32a1"
                className="navbar--content"
                target="_blank"
                rel="noreferrer"
              >
      ...
      <div className="footer--content--container">
        <p className="footer--content">Made with 💖 by Belayneh</p>
        <div className="footer--social--icon">
          <ul>
            <li>
              <Link
